...
Read `../../references/codex-adapter.md`, then use the installed **`$skill-creator`** workflow for Codex skill authoring. Treat `../../../skills/inscribe/SKILL.md` as intent/gating guidance only; do not create or modify the Claude source `skills/` tree.
