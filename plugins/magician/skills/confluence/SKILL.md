...
Read `../../references/codex-adapter.md`, then read `../../source-skills/confluence/SKILL.md` and follow the source skill through that Codex adapter. Keep the source skill's gates and rules.
